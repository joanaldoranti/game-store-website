...
<header>
    <nav class="navbar navbar-expand-lg bg-body-tertiary pt-3 pb-3" data-bs-theme="dark" style="background-color: #0b1521 !important;">
        <div class="container">
            <a class="navbar-brand" href="homeAdmin.php" style="padding: 10px 20px;">
            ...
            <div class="collapse navbar-collapse" id="navbarText">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="show_product.php">Store</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="admin_check.php">Verify</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="listPengguna.php">User</a>
                    </li>
                </ul>
                <ul class="navbar-nav justify-content-end">
                    <li class="nav-item">
                        <a class="nav-link text-white" href="homeAdmin.php"><?php echo $_SESSION['username']; ?></a>
                    </li>
