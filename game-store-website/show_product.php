        ...
        <table class="table text-light" style="background-color:#091b29">
            ...
            ?>
                <tr class="text-center">
                    ...
                    <td class="p-3">
                        <a href="edit_product.php?game_name=<?= $row["game_name"] ?>" class="btn btn-warning rounded-pill">EDIT</a>
                        <a href="delete_product.php?game_name=<?= $row["game_name"] ?>" class="btn btn-danger rounded-pill" onclick="Del(this.href);return:false;">DELETE</a>
                    </td>
                </tr>
            <?php
            }
...
<script language="Javascript">
    function Del(mypage) {
        var agree = confirm("คุณต้องการลบสินค้าหรือไม่");
        if (agree) {
